...
`testdata/aws-foundations-boundaries/helm`. The committed Terraform files
include a Kubernetes provider and a Helm release resource so that scan
covers Kubernetes and Helm under Terraform.
