...
Milestone 3 only renders Namespace from core Kubernetes. `make gitops-validate`
checks this exact path and SHA-256. Drift fails the gate. kubeconform is not
given `--ignore-missing-schemas`.
