...
CLI/action pins stay in `infra/aws/TERRAFORM_PINS.md`.
...
helm_version: 3.21.4
helm_git_commit: 813176c51bb5c181dbbd7901298ddcc104cd3417
...
* Version: `5.8.1`
* Source: annotated tag `kustomize/v5.8.1`
* Linux amd64 archive checksum: from the release `checksums.txt`
...
* Version: `0.8.0`
* Source: tag `v0.8.0`
* Linux amd64 archive checksum: from the release `CHECKSUMS` file
* Extracted linux amd64 binary checksum: computed after checksum verification

## Helm

* Version: `3.21.4`
* Source: annotated tag `v3.21.4` (matches `helm version` GitCommit)
* Linux amd64 archive checksum: from https://get.helm.sh/helm-v3.21.4-linux-amd64.tar.gz.sha256sum
* Extracted linux amd64 binary checksum: computed after checksum verification
...
* Source repository: `datreeio/CRDs-catalog` (commit message records Argo CD 3.5.0 CRDs)
